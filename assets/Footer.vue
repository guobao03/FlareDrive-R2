<template>
  <footer class="footer">
    ...
    <div class="project-links">
      <strong>项目:</strong><a href="https://github.com/guobao03/FlareDrive-R2" target="_blank"
        rel="noopener noreferrer">FlareDrive-R2</a>
      <strong>作者:</strong><a href="https://t.me/qiezii"
        rel="noopener noreferrer">@qiezii</a>
